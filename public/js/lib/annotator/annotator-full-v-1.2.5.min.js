...
((function() {
    ...
    }, a.fn.reverse = [].reverse, j = ["log", "debug", "info", "warn", "exception", "assert", "dir", "dirxml", "trace", "group", "groupEnd", "groupCollapsed", "time", "timeEnd", "profile", "profileEnd", "count", "clear", "table", "error", "notifyFirebug", "firebug", "userObjects"];
    ...
    c = function() {
        ...
        c = a.length % 4;
        if (c !== 0)
            for (b = 0, d = 4 - c; 0 <= d ? b < d : b > d; 0 <= d ? b++ : b--) a += "=";
