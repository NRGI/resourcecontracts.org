!(function (e, t) {
    ...
    if (V(i)) e._d = i;
      ...
      V(r)
        ...
        ? ((n = i),
          null !== (t = vt.exec(n._i))
            ? (n._d = new Date(+t[1]))
            : (St(n), !1 === n._isValid && (delete n._isValid, Ot(n), !1 === n._isValid && (delete n._isValid, n._strict ? (n._isValid = !1) : f.createFromInputFallback(n)))))
        : a(r)
  ...
  function $t(s, i) {
    return function (e, t) {
      ...
      return (
        null === t ||
          isNaN(+t) ||
          (Q(i, 'moment().' + i + '(period, number) is deprecated. Please use moment().' + i + '(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info.'),
          (n = e),
          (e = t),
          (t = n)),
        qt(this, C(e, t), s),
  ...
  (i.add = Ce),
    ...
    (i.isAfter = function (e, t) {
      return (
        (e = h(e) ? e : W(e)), !(!this.isValid() || !e.isValid()) && ('millisecond' === (t = _(t) || 'millisecond') ? this.valueOf() > e.valueOf() : e.valueOf() < this.clone().startOf(t).valueOf())
      );
    }),
    (i.isBefore = function (e, t) {
      return (
        (e = h(e) ? e : W(e)), !(!this.isValid() || !e.isValid()) && ('millisecond' === (t = _(t) || 'millisecond') ? this.valueOf() < e.valueOf() : this.clone().endOf(t).valueOf() < e.valueOf())
      );
    }),
    ...
    (i.isSame = function (e, t) {
      ...
      return (
        ...
        ('millisecond' === (t = _(t) || 'millisecond') ? this.valueOf() === e.valueOf() : ((e = e.valueOf()), this.clone().startOf(t).valueOf() <= e && e <= this.clone().endOf(t).valueOf()))
      );
    }),
    ...
    (i.utcOffset = function (e, t, n) {
      ...
      return (
        ...
        null != s && this.add(s, 'm'),
        i !== e &&
          (!t || this._changeInProgress ? qt(this, C(e - i, 'm'), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), f.updateOffset(this, !0), (this._changeInProgress = null))),
        this
      );
    }),
    (i.utc = function (e) {
  ...
  (w.calendar = function (e, t, n) {
    ...
    (w.weekdays = function (e, t) {
      return (
        (t = a(this._weekdays) ? this._weekdays : this._weekdays[e && !0 !== e && this._weekdays.isFormat.test(t) ? 'format' : 'standalone']), !0 === e ? Be(t, this._week.dow) : e ? t[e.day()] : t
      );
    }),
      ...
      for (this._weekdaysParse || ((this._weekdaysParse = []), (this._minWeekdaysParse = []), (this._shortWeekdaysParse = []), (this._fullWeekdaysParse = [])), s = 0; s < 7; s++) {
        if (
          ...
          this._weekdaysParse[s] ||
            ((i = '^' + this.weekdays(i, '') + '|^' + this.weekdaysShort(i, '') + '|^' + this.weekdaysMin(i, '')), (this._weekdaysParse[s] = new RegExp(i.replace('.', ''), 'i'))),
        ...
        null != t
          ? ((s = ot),
            null != R[e] && null != R[e].parentLocale
              ...
              : ((t = X((s = null != (n = dt(e)) ? n._config : s), t)), null == n && (t.abbr = e), ((s = new K(t)).parentLocale = R[e]), (R[e] = s)),
            ct(e))
